...
namespace DataMigrations
{
    ...
    [Migration("20210128234622_FavoriteStockTicker")]
    partial class FavoriteStockTicker
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SPA.Models.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SPA.Models.Entities.Stock", b =>
                {
                    b.HasOne("SPA.Models.Entities.ApplicationUser", "User")
                        .WithMany("Stocks")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
